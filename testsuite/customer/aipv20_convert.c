...
int main(int argc, char *argv[])
{
	 ...
	 * 1024*576 BGRA --->size: 0x240000
	 *
	*/
	if (iaic_ctx_init(&iaic_ctx, 0x400000)) {
	...
	img_nv12 = iaic_img_read(&iaic_ctx,
			...
			1024, 576, IAIC_NV12);
	// Convert image format from NV12 to BGRA
	img_bgra = iaic_cvt_format(&iaic_ctx,
			img_nv12, 1024, 576, IAIC_BGRA);
