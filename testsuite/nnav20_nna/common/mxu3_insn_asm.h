#ifndef __MXU3_INSN_ASM_H__
#define __MXU3_INSN_ASM_H__
...
#define GT_FMT(fmt, vrd, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gt" #fmt " %0, %1" : : "i"((vrd)), "i"((vrp)));                 \
	} while (0)
...
#define EXT_FMT_P(s, fmt, p, vrd, vrp)                                                             \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ext" #s "" #fmt "" #p " %0, %1" : : "i"((vrd)), "i"((vrp)));    \
	} while (0)
...
#define EXTU3BW(vrd, vrp)                                                                          \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_extu3bw %0, %1" : : "i"((vrd)), "i"((vrp)));                    \
	} while (0)

#define REPI(fmt, vrd, vrp, n)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_repi" #fmt " %0, %1[%2]" : : "i"((vrd)), "i"((vrp)), "i"((n))); \
	} while (0)
...
#define BSHLI(vrd, vrp, imm)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_bshli %0, %1, %2" : : "i"((vrd)), "i"((vrp)), "i"((imm)));      \
	} while (0)

#define BSHRI(vrd, vrp, imm)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_bshri %0, %1, %2" : : "i"((vrd)), "i"((vrp)), "i"((imm)));      \
	} while (0)

#define BSHR(vrd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_bshr %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)

#define BSHL(vrd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_bshl %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)
...
#define ABS(fmt, vrd, vrs)                                                                         \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_abs" #fmt " %0, %1" : : "i"((vrd)), "i"((vrs)));                \
	} while (0)
...
#define MLAW(vsd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mlaw %0, %1, %2" : : "i"((vsd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)

#define MLSW(vsd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mlsw %0, %1, %2" : : "i"((vsd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)
...
#define SATSS(fmt, tgt, vrd, vrs)                                                                  \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_satss" #fmt "" #tgt " %0, %1" : : "i"((vrd)), "i"((vrs)));      \
	} while (0)

#define SATSU(fmt, tgt, vrd, vrs)                                                                  \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_satsu" #fmt "" #tgt " %0, %1" : : "i"((vrd)), "i"((vrs)));      \
	} while (0)

#define SATUU(fmt, tgt, vrd, vrs)                                                                  \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_satuu" #fmt "" #tgt " %0, %1" : : "i"((vrd)), "i"((vrs)));      \
	} while (0)

#define TOC(fmt, vsd, vrs)                                                                         \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_toc" #fmt " %0, %1" : : "i"((vsd)), "i"((vrs)));                \
	} while (0)

// bitwise===============
#define ANDV(vrd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_andv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)

#define ANDNV(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_andnv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define ANDIB(vrd, vrs, imm)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_andib %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((imm)));      \
	} while (0)

#define ORV(vrd, vrs, vrp)                                                                         \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_orv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));        \
	} while (0)

#define ORNV(vrd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ornv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)

#define ORIB(vrd, vrs, imm)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_orib %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((imm)));       \
	} while (0)

#define XORV(vrd, vrs, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_xorv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));       \
	} while (0)

#define XORNV(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_xornv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define XORIB(vrd, vrs, imm)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_xorib %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((imm)));      \
	} while (0)

#define BSELV(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_bselv %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

// register load and misc
#define MTCPUW(rd, vwrp)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mtcpuw %0, %1" : "+r"((rd)) : "i"((vwrp)));                     \
	} while (0)

#define MFCPUW(vwrd, rs)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mfcpuw %0, %1" : : "i"((vwrd)), "r"((rs)));                     \
	} while (0)

#define SUMZ(vsd)                                                                                  \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_sumz %0" : : "i"((vsd)));                                       \
	} while (0)

#define MFSUMZ(vrd, vsd)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mfsumz %0, %1" : : "i"((vrd)), "i"((vsd)));                     \
	} while (0)

#define MFSUM(vrd, vss)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mfsum %0, %1" : : "i"((vrd)), "i"((vss)));                      \
	} while (0)

#define MTSUM(vsd, vrs)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_mtsum %0, %1" : : "i"((vsd)), "i"((vrs)));                      \
	} while (0)

#define LIW(vrd, imm)                                                                              \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_liw %0, %1" : : "i"((vrd)), "i"((imm)));                        \
	} while (0)

#define LIWH(vrd, imm)                                                                             \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_liwh %0, %1" : : "i"((vrd)), "i"((imm)));                       \
	} while (0)

#define LIH(vrd, imm)                                                                              \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_lih %0, %1" : : "i"((vrd)), "i"((imm)) : "memory");             \
	} while (0)
...
#define SHUF(fmt, grp, vrd, vrp)                                                                   \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_shuf" #fmt "" #grp " %0, %1" : : "i"((vrd)), "i"((vrp)));       \
	} while (0)
...
#define CLTU(fmt, vrd, vrs, vrp)                                                                   \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_cltu" #fmt " %0, %1, %2"                                        \
							 :                                                                     \
							 : "i"((vrd)), "i"((vrs)), "i"((vrp)));                                \
	} while (0)
...
#define CLTZ(fmt, vrd, vrs)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_cltz" #fmt " %0, %1" : : "i"((vrd)), "i"((vrs)));               \
	} while (0)

#define CLEZ(fmt, vrd, vrs)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_clez" #fmt " %0, %1" : : "i"((vrd)), "i"((vrs)));               \
	} while (0)

#define CEQ(fmt, vrd, vrs, vrp)                                                                    \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ceq" #fmt " %0, %1, %2"                                         \
							 :                                                                     \
							 : "i"((vrd)), "i"((vrs)), "i"((vrp)));                                \
	} while (0)
...
#define GATHER(small, fmt, vrd, vrp)                                                               \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gt" #small "" #fmt " %0, %1" : : "i"((vrd)), "i"((vrp)));       \
	} while (0)

#define ADDIW(vwrd, vwrp, imm)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_addiw %0, %1, %2" : : "i"((vwrd)), "i"((vwrp)), "i"((imm)));    \
	} while (0)

#define ADDRW(vwrd, vwrp)                                                                          \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_addrw %0, %1" : : "i"((vwrd)), "i"((vwrp)));                    \
	} while (0)

#define LIWR(vwrd, imm)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_liwr %0, %1" : : "i"((vwrd)), "i"((imm)));                      \
	} while (0)

// neural networks acelerate
#define NNRWR(vwrp, imm)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nnrwr %0, %1" : : "i"((vwrp)), "i"((imm)));                     \
	} while (0)

#define NNRRD(vrd, imm)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nnrrd %0, %1" : : "i"((vrd)), "i"((imm)));                      \
	} while (0)

#define NNDWR(vrp, imm)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nndwr %0, %1" : : "i"((vrp)), "i"((imm)));                      \
	} while (0)

#define NNDRD(vrd, imm)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nndrd %0, %1" : : "i"((vrd)), "i"((imm)));                      \
	} while (0)

#define NNCMD(imm)                                                                                 \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nncmd %0" : : "i"((imm)));                                      \
	} while (0)

#define NNMAC(vwrp, imm)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_nnmac %0, %1" : : "i"((vwrp)), "i"((imm)));                     \
	} while (0)
...
#define FADDW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_faddw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FSUBW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fsubw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FMULW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fmulw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FCMULRW(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fcmulrw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));    \
	} while (0)

#define FCMULIW(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fcmuliw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));    \
	} while (0)

#define FCADDW(vrd, vrs, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fcaddw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));     \
	} while (0)

#define FXAS(fmt, vrd, vrp)                                                                        \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fxas" #fmt " %0, %1" : : "i"((vrd)), "i"((vrp)));               \
	} while (0)

#define FMAXW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fmaxw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FMAXAW(vrd, vrs, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fmaxaw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));     \
	} while (0)

#define FMINW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fminw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FMINAW(vrd, vrs, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fminaw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));     \
	} while (0)

#define FCLASSW(vrd, vrs)                                                                          \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fclassw %0, %1" : : "i"((vrd)), "i"((vrs)));                    \
	} while (0)

#define FCEQW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fceqw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FCLEW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fclew %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FCLTW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fcltw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FCORW(vrd, vrs, vrp)                                                                       \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_fcorw %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));      \
	} while (0)

#define FFSIW(vrd, vrs)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ffsiw %0, %1" : : "i"((vrd)), "i"((vrs)));                      \
	} while (0)

#define FFUIW(vrd, vrs)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ffuiw %0, %1" : : "i"((vrd)), "i"((vrs)));                      \
	} while (0)

#define FTSIW(vrd, vrs)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ftsiw %0, %1" : : "i"((vrd)), "i"((vrs)));                      \
	} while (0)

#define FTUIW(vrd, vrs)                                                                            \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ftuiw %0, %1" : : "i"((vrd)), "i"((vrs)));                      \
	} while (0)

#define FRINTW(vrd, vrs)                                                                           \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_frintw %0, %1" : : "i"((vrd)), "i"((vrs)));                     \
	} while (0)

#define FTRUNCSW(vrd, vrs)                                                                         \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ftruncsw %0, %1" : : "i"((vrd)), "i"((vrs)));                   \
	} while (0)

#define FTRUNCUW(vrd, vrs)                                                                         \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ftruncuw %0, %1" : : "i"((vrd)), "i"((vrs)));                   \
	} while (0)

#define CTCMXU(mcsrd, rs)                                                                          \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_ctcmxu %0, %1" : : "i"((mcsrd)), "r"((rs)));                    \
	} while (0)

#define CFCMXU(rd, mcsrs)                                                                          \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_cfcmxu %0, %1" : "=r"((rd)) : "i"((mcsrs)));                    \
	} while (0)

/* mxu3.1 */
#ifdef __mips_mxu3_1

#define GSHUFWB_1(vrd, vrs, vrp, imm)                                                              \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufwb1 %0, %1, %2, %3"                                        \
							 :                                                                     \
							 : "i"((vrd)), "i"((vrs)), "i"((vrp)), "i"((imm)));                    \
	} while (0)

#define GSHUFWB_2(vrd, vrs, vrp, imm)                                                              \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufwb2 %0, %1, %2, %3"                                        \
							 :                                                                     \
							 : "i"((vrd)), "i"((vrs)), "i"((vrp)), "i"((imm)));                    \
	} while (0)

#define GSHUFVB(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufvb %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));    \
	} while (0)

#define GSHUFWB(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		GSHUFWB_1(vrd, vrs, vrp, 0);                                                               \
	} while (0)
#else //__mips_mxu3_1

#define GSHUFWB(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufwb %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));    \
	} while (0)

#define GSHUFB(vrd, vrs, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufb %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));     \
	} while (0)

#define GSHUFWH(vrd, vrs, vrp)                                                                     \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufwh %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));    \
	} while (0)

#define GSHUFH(vrd, vrs, vrp)                                                                      \
	do {                                                                                           \
		__asm__ __volatile__("mxu3_gshufh %0, %1, %2" : : "i"((vrd)), "i"((vrs)), "i"((vrp)));     \
	} while (0)
...
#define _PERF_CNTR_BEGIN_INS_ asm volatile(".word 0x46200006");
#define _PERF_CNTR_END_INS_ asm volatile(".word 0x46200846");

#endif //__MXU3_INSN_ASM_H__
