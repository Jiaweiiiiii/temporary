...
def def_mxu3_1_asm(asm):
    if asm.name.lower() == "nop":
    ...
    elif asm.name.lower() == "gshufwb1":
        if (len(asm.field) != 4) and (4 != 0):
            return 'error asm format'

        insn = 0x7280003b
        insn |= ((asm.field[3] >> 0) & 0x1) << 21 # imm 
        insn |= ((asm.field[1] >> 0) & 0x1f) << 16 # vrs 
        insn |= ((asm.field[2] >> 0) & 0x1f) << 11 # vrp 
        insn |= ((asm.field[0] >> 0) & 0x1f) << 6 # vrd 
        asm.asm_str = "gshufwb1 vrd, vrs, vrp, imm"
    elif asm.name.lower() == "gshufwb2":
        if (len(asm.field) != 4) and (4 != 0):
            return 'error asm format'
        ...
        insn |= ((asm.field[2] >> 0) & 0x1f) << 11 # vrp 
        insn |= ((asm.field[0] >> 0) & 0x1f) << 6 # vrd 
        asm.asm_str = "gshufwb2 vrd, vrs, vrp, imm"
    elif asm.name.lower() == "gshufvb":
        if (len(asm.field) != 3) and (3 != 0):
            return 'error asm format'
        ...
        insn |= ((asm.field[2] >> 0) & 0x1f) << 11 # vrp 
        insn |= ((asm.field[0] >> 0) & 0x1f) << 6 # vrd 
        asm.asm_str = "gshufvb vrd, vrs, vrp"
