...
// 1.4 dynamin generate tlb refill handle, beause the DDR traning can destroy
// TLB refill handle 1.5 add invalidate cache 2.0 support palladium 2.1 the
// function "printk" is fast
...
/* Thread num band core num, it is return error, if max thread num > max core
 * num. */
