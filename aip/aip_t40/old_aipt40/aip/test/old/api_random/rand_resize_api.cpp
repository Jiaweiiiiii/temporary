...
int main(int argc, char** argv)
{
    ...
    for (int idx = idx_st; idx < idx_end; idx++) {
        ...
        uint8_t mode_sel =2;
        api_mode_sel_e mode_sel_e[8] = {bresize_chn2chn,bresize_nv2chn,affine_bgr2bgr,affine_nv2bgr,affine_nv2nv,perspective_bgr2bgr,perspective_nv2bgr,perspective_nv2nv};
        mode_sel = rand()%9;
        //mode_sel = 4;
        //except nv12-nv12
