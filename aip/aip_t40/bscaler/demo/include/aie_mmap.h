...
#define BSCALER_IO_BASE    0x13090000        // A1  address
...
uint32_t __aie_get_ddr_paddr(uint32_t ddr_vaddr) {
    return (unsigned long)__ddr_pbase + (ddr_vaddr - (unsigned long)__ddr_vbase);
}
inline __attribute__((always_inline))
uint32_t __aie_get_oram_paddr(uint32_t oram_vaddr) {
    return (unsigned long)ORAM_BASE + (oram_vaddr - (unsigned long)__oram_vbase);
}
inline __attribute__((always_inline))
uint32_t __aie_get_oram_offset(uint32_t oram_vaddr) {
    return (unsigned long)L2C_SIZE + (oram_vaddr - (unsigned long)__oram_vbase);
}
inline __attribute__((always_inline))
uint32_t __aie_get_oram_vbase() {
    return (unsigned long)__oram_vbase;
}
inline __attribute__((always_inline))
uint32_t __aie_get_nndma_io_vbase() {
    return (unsigned long)__nndma_io_vbase;
}
inline __attribute__((always_inline))
uint32_t __aie_get_nndma_desram_vbase() {
    return (unsigned long)__nndma_desram_vbase;
}
inline __attribute__((always_inline))
uint32_t __aie_get_nndbg_io_vbase() {
    return (unsigned long)__nndbg_io_vbase;
}
inline __attribute__((always_inline))
uint32_t __aie_get_bscaler_io_vbase() {
    return (unsigned long)__bscaler_io_vbase;
}
inline __attribute__((always_inline))
uint32_t __aie_get_desram_cache_attr() {
    return (unsigned long)__nndma_desram_cache_attr;
}
inline __attribute__((always_inline))
uint32_t __aie_get_oram_cache_attr() {
    return (unsigned long)__oram_vbase_cache_attr;
}
inline __attribute__((always_inline))
uint32_t __aie_get_ddr_cache_attr() {
    return (unsigned long)__ddr_vbase_cache_attr;
}
